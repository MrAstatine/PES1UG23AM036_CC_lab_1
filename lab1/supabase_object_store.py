...
SUPABASE_URL = (
    "https://uwjvdnawzyusckusdenu.supabase.co"  # Replace with your Supabase URL
)
SUPABASE_KEY = "sb_publishable_BBzESN7tjwhX5Np7kGc1nw_8LDsDC9p"  # Replace with your Supabase API key
image_path = "CC/cat.jpeg"  # Replace with the local image path
image_name = "cat.jpeg"  # Desired name for the uploaded file̥
supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)
bucket_name = "CC_lab1_bucket"  # Name of the bucket to be created
